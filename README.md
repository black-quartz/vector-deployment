...
The Vector agent is configured to stream collected observability data to the Vector aggregator, which handles downstream processing before forwarding events to their destinations.
